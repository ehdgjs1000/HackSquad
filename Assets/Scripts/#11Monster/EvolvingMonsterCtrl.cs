...
public class EvolvingMonsterCtrl : MonoBehaviour
{
    ...
    private void AttackCheck()
    {
        ...
        if (playerColl.Length > 0 && !EvolvingDungeonManager.instance.isGameOver)
        {
    ...
    protected virtual IEnumerator Attack()
    {
        ...
        EvolvingDungeonManager.instance.GetDamage(damage);
    }
