...
public class GoldMonsterCtrl : MonoBehaviour
{
    ...
    protected virtual IEnumerator Die()
    {
        ...
        GoldDungeonManager.instance.getGold += gold;
    ...
    private void AttackCheck()
    {
        ...
        if (playerColl.Length > 0 && !GoldDungeonManager.instance.isGameOver)
        {
    ...
    protected virtual IEnumerator Attack()
    {
        ...
        GoldDungeonManager.instance.GetDamage(damage);
    }
